  ...
  return (
    ...
    <div className="map-tools-group map-tools-group--draw">
      ...
      <button
        ...
        className={`btn btn-sm map-tool-btn map-tool-btn--with-label ${drawMode === 'pad_placement' ? 'btn-primary active' : 'btn-secondary'}`}
      ...
      <div ref={bottomholeMenuAnchorRef} className="inline-block">
        ...
        <button
          ...
          className={`btn btn-sm map-tool-btn map-tool-btn--with-label ${bottomholeActive ? 'btn-primary active' : 'btn-secondary'}`}

...
export function buildSidePanelsSection(
  ...
  return {
    ...
    padPlacementDetails: actions.padPlacementDetails,
    padPlacementParams: actions.padPlacementParams,
    setPadPlacementParams: actions.setPadPlacementParams,
    padPlacementSubtype: actions.padPlacementSubtype,
    setPadPlacementSubtype: actions.setPadPlacementSubtype,
    padPlacementComputeResult: actions.padPlacementComputeResult,
    padPlacementSelectedVariant: actions.padPlacementSelectedVariant,
    setPadPlacementSelectedVariant: actions.setPadPlacementSelectedVariant,
    onPadPlacementCompute: () => actions.padPlacementComputeMut.mutate(),
    onPadPlacementApply: () => actions.padPlacementApplyMut.mutate(),
    padPlacementComputePending: actions.padPlacementComputeMut.isPending,
    padPlacementApplyPending: actions.padPlacementApplyMut.isPending,
    canPadPlacementCompute: actions.canPadPlacementCompute,
    padPlacementDisabledHint: actions.padPlacementDisabledHint,
    onClearPadPlacementBottomholes: () => actions.setPadPlacementBottomholeIds([]),
    onRemovePadPlacementItem: (id: string) =>
      actions.setPadPlacementBottomholeIds((ids) => ids.filter((x) => x !== id)),
    onAddVisiblePadPlacementBottomholes: actions.handleAddVisiblePadPlacementBottomholes,
    padPlacementVisibleEligibleCount: actions.padPlacementVisibleEligibleCount,
  };
}

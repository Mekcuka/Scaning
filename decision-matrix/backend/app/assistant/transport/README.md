...
| URI | Источник |
|-----|----------|
| `docs://calculation-logic` | `docs/calculations/calculation-logic-flow.md` |
| `docs://infrastructure-subtypes` | `decision-matrix/shared/infrastructure_subtypes.json` |
| `openapi://v1` | `app.openapi()` (lazy import) |

Модуль: [`resources.py`](resources.py). Auth: тот же Bearer JWT.

...
| `volume_grid.py` | Cut/fill по сетке относительно design surface (unit-тесты) |
| `dem_volume.py` | DEM: выемка выше опорной отметки в footprint |
...
Режим DEM: `fill_m3 = площадь × H`, `cut_m3` — грунт выше опорной в контуре, `net_fill_m3 = fill_m3`. См. [pad-earthwork.md](../../docs/features/pad-earthwork/pad-earthwork.md) § Модель объёмов.

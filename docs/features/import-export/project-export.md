...
**Связанные документы:** [user-flows.md](../../product/user-flows.md) §2.3, [project-import.md](../import-export/project-import.md), [import через GeoJSON](../map/map-objects-and-spatial-calculations.md), [implementation-status.md](../../planning/implementation-status.md)

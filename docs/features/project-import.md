...
**Связанные документы:** [user-flows.md](../product/user-flows.md) §2.1, [project-export.md](project-export.md), [spark-import-mapping.md](spark-import-mapping.md), [well-trajectory.md](well-trajectory.md), [implementation-status.md](../planning/implementation-status.md)
...
- Импорт Искра (SPARK) — тот же канал «Импорт файлов», см. [spark-import-mapping.md](spark-import-mapping.md).

...
| [frontend-structure.md](./frontend-structure.md) | **Структура frontend после рефакторинга карты** (MapPage, MapView, api) |
...
Подробнее: [frontend-structure.md](./frontend-structure.md).

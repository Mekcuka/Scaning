...
| [assistant.md](architecture/assistant.md) | **AI Assistant:** Shared Tool Registry, MCP, чат, фазы 2–9; §16 — роутинг tools и server formatters (фаза 7) |
...
| [project-export.md](features/project-export.md) | Экспорт координат и GeoJSON (`/export`): выбор проекта, карточки форматов |

...
| [repo-layout.md](architecture/repo-layout.md) | **Карта монорепо** — data, vendor, lib/domains |
...
Документы сгруппированы по фичам — см. [features/README.md](features/README.md).

| Папка | Содержание |
|-------|------------|
| [map/](features/map/) | **Объекты карты**, 2D/3D, PostGIS — [map-objects-and-spatial-calculations.md](features/map/map-objects-and-spatial-calculations.md), [map-3d-features.md](features/map/map-3d-features.md), [map-3d-plan.md](features/map/map-3d-plan.md) |
| [import-export/](features/import-export/) | Импорт/экспорт — [project-import.md](features/import-export/project-import.md), [project-export.md](features/import-export/project-export.md), [spark-import-mapping.md](features/import-export/spark-import-mapping.md) |
| [flows/](features/flows/) | **Схема потоков (PFD)** — [fluid-flow-schematic.md](features/flows/fluid-flow-schematic.md), [economic-flow-schematic.md](features/flows/economic-flow-schematic.md) |
| [assistant/](features/assistant/) | **AI Assistant** — [assistant-tools.md](features/assistant/assistant-tools.md) |
| [jobs/](features/jobs/) | Журнал задач — [task-log-panel.md](features/jobs/task-log-panel.md) |
| [pad-earthwork/](features/pad-earthwork/) | **Земляные работы куста** — [pad-earthwork.md](features/pad-earthwork/pad-earthwork.md) |
| [well-trajectory/](features/well-trajectory/) | **Траектории и «Кустование»** (M1–M3 ✅) — [well-trajectory.md](features/well-trajectory/well-trajectory.md), [roadmap](features/well-trajectory/well-trajectory-roadmap.md) |
| [pad-placement/](features/pad-placement/) | **Оптимизация размещения кустов** (✅) — [pad-placement-optimization.md](features/pad-placement/pad-placement-optimization.md) |
| [line-elevation-profile/](features/line-elevation-profile/) | **Профиль высот линий** (✅) — [line-elevation-profile.md](features/line-elevation-profile/line-elevation-profile.md) |
...
| [solid-refactoring-plan.md](planning/solid-refactoring-plan.md) | План SOLID-рефакторинга |

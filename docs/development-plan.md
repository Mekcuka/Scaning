...
> **Статус (май 2026):** ядро MVP в `decision-matrix/` реализовано. Актуальная сводка «док ↔ код» — [implementation-status.md](./implementation-status.md). Чеклисты ниже — **исторический план**; отмечены выполненные пункты по факту.

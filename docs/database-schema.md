...
> **Параметры ввода:** id полей и значения по умолчанию — [input-parameters.md](./input-parameters.md).  
> **Геометрия объектов и якоря расчёта:** [map-objects-and-spatial-calculations.md](./map-objects-and-spatial-calculations.md).
...
Явный граф для линейной инфраструктуры. Спецификация: [map-objects-and-spatial-calculations.md](./map-objects-and-spatial-calculations.md) §5.

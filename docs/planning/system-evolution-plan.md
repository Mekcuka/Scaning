...
| Монолит `index.css` (~9k строк) | Снижено (2026-06) | Split → `src/styles/` (35 файлов; `features/map/`, `components/app-modal/`), `css-segments.mjs`, `npm run verify:css`; см. [ui-guidelines.md](../architecture/ui-guidelines.md) |

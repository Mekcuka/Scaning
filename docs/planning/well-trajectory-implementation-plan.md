...
> **Основа:** [roadmap](well-trajectory-roadmap.md), [оценка приложения](well-trajectory-app-assessment.md), [модель данных](well-trajectory-data-model.md), [feature spec](../features/well-trajectory.md).

**Дата:** июнь 2026.

**Ориентир:** все сущности и API привязаны к объекту **куста** (`oil_pad`, `gas_pad`). Единственный источник устьев — `pad_wells_local_json` и параметры куста из [pad-earthwork](../features/pad-earthwork.md).
...
| Когда | Файл |
|-------|------|
| M1 | [implementation-status.md](implementation-status.md) → ✅ фаза 1 |
| M1 | [well-trajectory.md](../features/well-trajectory.md) — актуализировать API |
| M2 | [implementation-status.md](implementation-status.md) → ✅ фаза 2 |
| M2 | [map-3d-features.md](../features/map-3d-features.md) — слой well_trajectories на `/map` |
| M3 | [implementation-status.md](implementation-status.md) → M3 ✅; [well-trajectory.md](../features/well-trajectory.md) — clearance API + SF UI |
...
| [pad-earthwork.md](../features/pad-earthwork.md) | Источник wells_local |

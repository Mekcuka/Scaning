...
| Профиль высот линий | BFF `line_elevation_profile/*`; один ЦМР `project_line_dem`; сэмплинг polyline; вкладка **Профиль**; job `line_elevation_profile_compute` — [line-elevation-profile.md](../features/line-elevation-profile/line-elevation-profile.md) | ✅ таблица + Excel, ARQ |
...
| Профиль высот линий | [line-elevation-profile.md](../features/line-elevation-profile/line-elevation-profile.md) |
